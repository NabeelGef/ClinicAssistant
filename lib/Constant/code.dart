...
//Make a const Drawer in Doctor and clinic page
 ...
 static  Widget  DrawerNative(BuildContext context , GlobalKey<ScaffoldState> key){
    return Align(
          ...
          child: ListView(
            ...
            Align(
              ...
              child: InkWell(
                ...
                child:Icon(Icons.close ,size: Sizer.getTextSize(context, 0.09), color: Colors.white),
        ),
            ),
                ...
                InkWell(
                  ...
                  child: Row(
                    ...
                    children: [
                      Icon(Icons.home , color: Colors.white, size: Sizer.getTextSize(context, 0.08)),
                      SizedBox(width: 20,),
                      Text("الصّفحة الرّئيسيّة", style: TextStyle(color: Colors.white ,
                          fontFamily: Font.fontfamily ,
                          fontSize: Sizer.getTextSize(context, 0.05),
                          fontWeight: FontWeight.bold)),
                      SizedBox(width: 20),
                ...
                InkWell(
                  ...
                  child: Row(
                    ...
                    children: [
                      Icon(Icons.key , color: Colors.white, size: Sizer.getTextSize(context, 0.08)),
                      SizedBox(width: 20,),
                      Text("تسجيل الدّخول", style: TextStyle(color: Colors.white ,
                          fontFamily: Font.fontfamily ,
                          fontSize: Sizer.getTextSize(context, 0.05),
                          fontWeight: FontWeight.bold)),
                      SizedBox(width: 20),
                ...
                InkWell(
                  ...
                  child: Row(
                    ...
                    children: [
                      Icon(Icons.info_outline_rounded , color: Colors.white, size: Sizer.getTextSize(context, 0.08)),
                      SizedBox(width: 20),
                      Text("حول النّظام", style: TextStyle(color: Colors.white ,
                          fontFamily: Font.fontfamily ,
                          fontSize: Sizer.getTextSize(context, 0.05),
                          fontWeight: FontWeight.bold)),
                      SizedBox(width: 20),
                ...
                InkWell(
                  ...
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.end,
                    children: [
                      Icon(Icons.settings , color: Colors.white, size: Sizer.getTextSize(context, 0.08)),
                      SizedBox(width: 20),
                      Text("الإعدادات",
                ...
                InkWell(
                  ...
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.end,
                    children: [
                      Icon(Icons.privacy_tip_outlined , color: Colors.white, size: Sizer.getTextSize(context, 0.08)),
                      SizedBox(width: 10),
 ...
 static Widget AppBarDoctorsAndClinics(GlobalKey<ScaffoldState> _scaffoldkey
   ...
   return AppBar(
     ...
     leading: InkWell(
         ...
         child: Icon(Icons.notifications_none_outlined ,size: Sizer.getTextSize(context, 0.08), color: Colors.white)),
     actions: [
      Container(
           margin: EdgeInsets.only(right: 6.sp),
           child: Icon(Icons.filter_alt ,size: Sizer.getTextSize(context, 0.08), color: Colors.white)),
       InkWell(
           onTap: () =>    _scaffoldkey.currentState!.openEndDrawer(),
           child: Container(
               margin: EdgeInsets.only(right: 6.sp),
               child: Icon(Icons.menu ,size: Sizer.getTextSize(context, 0.08), color: Colors.white)))
     ],
     title: Container(
       width: Sizer.getWidth(context),
       decoration: BoxDecoration(
       ...
       child: Row(
         children: [
           ...
           Expanded(
             flex: 5,
             child: Container(
               height: Sizer.getHeight(context)/18,
                     child: TextField(
                       inputFormatters: [
           ...
           Expanded(child: Icon(Icons.search_rounded , size: Sizer.getTextSize(context, 0.08), color: Colors.white))
         ],
       ),
     ),
     elevation: 0,
