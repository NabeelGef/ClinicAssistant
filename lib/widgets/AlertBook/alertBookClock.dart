          ...
          children: [
            ...
            BlocBuilder<ConnectivityBloc, ConnectivityState>(
              ...
              if (connect is ConnectivityInitial) {
                ...
                if (!isLoading) {
                  alertBookBloc.add(LoadingEventAlertBookClock(
                      widget.workTimeId!, widget.token));
                }
                return Expanded(
                  child: Column(
                    children: [
                          ...
                          if (state.successAlertBookClock!.workTimeClock ==
                            ...
                            return Expanded(
                              ...
                              child: GridView.builder(
                                itemCount: state.successAlertBookClock!
                                    .workTimeClock!.appointment!.length,
                                    ...
                                    onTap: () {
                                      if (!isBooked) {
                                        appointment = state
                                            ...
                                            .workTimeClock!
                                            .appointment![index];
                                        alertBookBloc.add(SelectTime(index,
                      ...
                      BlocBuilder<AlertBookBloc, StateAlertBook>(
                          ...
                          builder: (context, state) {
                            if (state.successAlertBookClock!.workTimeClock ==
                                null) {
                              if (state
                                  .successAlertBookClock!.error.isNotEmpty) {
                                return SizedBox();
                              } else {
                                return SizedBox();
                              }
